const IconMuscle = ({ className }: { className?: string }) => (
    <svg className={className} width="800px" height="800px" viewBox="0 0 48 48" fill="none">
        ...
        <path d="M17.4399 17.13L22 34" stroke="currentColor" strokeWidth="3" strokeMiterlimit="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
)
