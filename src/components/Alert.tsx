const Alert = ({ handleConfirm, handleCancel }: { handleConfirm: () => void, handleCancel: () => void }) => {
    return (
        <div className="fixed inset-0 bg-base-200/50 transition-opacity duration-500 ease-in-out data-closed:opacity-0">
            <div className="mx-auto sm:w-3/4 md:w-2/4 fixed inset-0 flex items-center">
                <div className="card bg-base-100 card-border border-base-300 card-sm p-4">
