...
const Alert = ({ handleConfirm, handleCancel }: { handleConfirm: (event: ChangeEvent<HTMLInputElement>) => void, handleCancel: () => void }) => {
    return (
            ...
            <div className="mx-auto sm:w-3/4 md:w-2/4 fixed inset-0 flex items-center justify-center">
                <div className="card bg-base-100 card-border border-base-300 card-sm p-4 m-2">
                    ...
                    <div className="flex pt-4 gap-2">
                        <label htmlFor="file" className="btn btn-sm btn-error">
                            <input
                                type="file"
